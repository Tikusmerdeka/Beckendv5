...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[41;97;1m                  MAZFARUKSTORE                \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Tikusmerdeka/Beckendv5/main/ipme | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Tikusmerdeka/Beckendv5/main/ipme | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Tikusmerdeka/Beckendv5/main/ipme | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Tikusmerdeka/Beckendv5/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Tikusmerdeka/Beckendv5/main/ipme | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Tikusmerdeka/Beckendv5/main/ipme | grep $ipsaya | awk '{print $3}')
